...
namespace Booking.API.Repositories
{
	public class BookingTourRepository : RepositoryBase<BookingTour, int, BookingDbContext>
	{
		...
		public async Task<IEnumerable<BookingTour>> GetBookingToursAsync() =>
			await FindByCondition(h => h.DeletedAt == null, false, h => h.TourBookingRooms).ToListAsync();
		...
		public Task CreateBookingTourAsync(BookingTour bookingTour) => CreateAsync(bookingTour);

		public Task UpdateBookingTourAsync(BookingTour bookingTour) => UpdateAsync(bookingTour);
